...
const RenderHandler = () => {
  ...
  }, [currentTemplateId, files, inputProps, renderingStatus]);
                ...
                <div className={styles.modal}>
                  ...
                  <div className={styles.buttons}>
                    ...
                    <button className={styles.share}>
                      <Share color="var(--color-foreground)" />
                    </button>
                    {/* Export */}
                    <a
  ...
  }, [finalStuffToSend, renderingStage, renderingProgress, setModal, setRenderingStatus]);
